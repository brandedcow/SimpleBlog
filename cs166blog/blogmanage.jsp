...
<html>
	...
	<div class="intro">
		<div class="container">
			<div class="units-row">
			    ...
			    <div class="unit-90">
			    	<p class="p-intro">MANAGE YOUR POSTS <%= username %></p>
			    </div>
			</div>
		</div>
	</div>
	...
	<div class="content">
		<div class="container">
            <div class="post">
                <form action="editblog_action.jsp" method="post">
                    <input name="token" type="hidden" value="${sessionScope.CSRF}" />                

                Blog Title: <input name="blogtitle" size=50/>
                <input type="submit" value="Edit"/>
                </form>
                
                <form action="deleteblog_action.jsp" method="post">
                    <input name="token" type="hidden" value="${sessionScope.CSRF}" />                
            ...
            <%	
               ...
               else if (temp.equals(session.getAttribute("user"))){
                    out.print("<div class='post'>");
	               out.print("<h1>" + rs.getString(1) + "</h1>");
                    out.print("<hr>");
