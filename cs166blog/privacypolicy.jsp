		...
		<div class="container">
			<header class="group top-nav">
			    ...
			    <nav id="navbar-1" class="navbar item-nav navbar-right">
				    <ul>
				        <li class="active"><a href="blogs.jsp">Home</a></li>
				        <li><a href="privacypolicy.jsp">About</a></li>
	...
	<div class="intro">
		<div class="container">
			<div class="units-row">
			    ...
			    <div class="unit-90">
			    	<p class="p-intro">PRIVACY STUFF <%= username %>!</p>
			    </div>
			</div>
		</div>
	</div>
...
</style><div id='ppHeader'>Blog Privacy Policy</div><div id='ppBody'><div class='ppConsistencies'><div class='col-2'>
