...
String sql ="SELECT user, type FROM login";                    
...
<html>
	...
	<div class="intro">
		<div class="container">
			<div class="units-row">
			    ...
			    <div class="unit-90">
			    	<p class="p-intro">MANAGE YOUR PEOPLE <%= username %></p>
			    </div>
			</div>
		</div>
	</div>
	...
	<div class="content">
		<div class="container">
            <div class="post">
                <form action="deleteuser_action.jsp" method="post">
              <input name="token" type="hidden" value="${sessionScope.CSRF}" />
                    
                Delete User: <input name="usertd" size=50/>
                <input type="submit" value="Confirm"/>
                </form>
                
                <form action="makeadmin_action.jsp" method="post">
              <input name="token" type="hidden" value="${sessionScope.CSRF}" />
                    
                Change Type: <input name="usertu" size=50/>
                <input type="submit" value="Confirm"/>
                </form>
            </div>
            <%	
